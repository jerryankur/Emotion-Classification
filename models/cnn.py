from tensorflow.keras.layers import Activation, Convolution2D, Dropout, Conv2D, Dense, multiply
...
def mini_XCEPTION_with_attention(input_shape, num_classes, l2_regularization=0.01):
    regularization = l2(l2_regularization)
